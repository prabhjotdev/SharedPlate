          ...
          {isSignUp && (
            <div>
              <input
                ...
                className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none text-base bg-white text-gray-900 placeholder:text-gray-500"
              />
            </div>
          )}
          <div>
