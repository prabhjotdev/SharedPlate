...
export default function LoginPage() {
  ...
  // Redirect if already authenticated and allowed
    ...
    <div className="flex flex-col justify-center min-h-screen bg-warm-50 px-6">
      <div className="max-w-sm mx-auto w-full">
          ...
          {isSignUp && (
            <div>
              <input
                ...
                className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none text-base bg-white text-gray-900 placeholder:text-gray-400"
              />
            </div>
          )}
          <div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full border border-gray-300 py-3 rounded-xl font-medium flex items-center justify-center gap-3 bg-white text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 min-h-[52px]"
        >
